...
router
  .route("/comments")
  .get(
    asyncHandler(commentController.getAllData)
  )
  .post(
    asyncHandler(uploadCoverImage),
    asyncHandler(validateRequestBody(commentController.CommentsJoiSchema.AddData)),
...
router
  .route("/comment/:id")
  .get(
    asyncHandler(commentController.getDataById)
  )
  .patch(
    asyncHandler(
  ...
  .delete(
    asyncHandler(commentController.deleteDataById)
  );
